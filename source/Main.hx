...
class Main extends Sprite
{
	...
	final framerate:Int = Std.parseInt(CoolUtil.coolTextFileString(Paths.optionsTxt('fps'))); // How many frames per second the game should run at.
	...
	private function setupGame():Void
	{
		...
		#if !mobile
		memoryCounter = new MemoryCounter(0, 0, 0xffffff);
